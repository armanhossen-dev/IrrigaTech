...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  static const _slides = [
    ...
    (
      ...
      title: 'Operational alerts and history',
      body:
          'Rain, tank, tamper and boot events follow the EcoSense field order, with charts and Google Sign-In.',
    ),
  ];
                    ...
                    return Column(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: Icon(s.icon, size: 28, color: AppColors.teal),
